...
\cvsetaddress{
    \cvenglish{
        ul.~Aviatorov~d.~5~k.~4,~kv.~14\\
        g.~Moskva\\
        119619\\
        Russian~Federation
    }
    \cvrussian{
        ул.~Авиаторов~д.~5~к.~4,~кв.~14\\
        г.~Москва\\
        119619\\
        Россия
    }
}
\cvsetphone{+7~916~083~22~23}
\cvsetemail{thoughteer@gmail.com}
\cvsethomepage{https://github.com/thoughteer}
...
\begin{document}
    ...
    \begin{cvsection}{\cvenglish{Skills}\cvrussian{Навыки}}
        ...
        \cventry{%
            ...
            Python, Java, C\,/\,C++, Bash, Golang, Matlab, ECMAScript, Factor, SQL
        }
        \cventry{\cvenglish{technologies}\cvrussian{технологии}}{
            AWS, Kubernetes, Spark, Hadoop\,/\,Hive, ZooKeeper, Kafka, MongoDB, Grafana, Prometheus, HashiCorp Vault, CUDA, OpenGL, DICOM, \LaTeX, HTML, CSS
        }
    ...
    \begin{cvsection}{\cvenglish{Spoken Languages}\cvrussian{Языки}}
        \cventry{\cvenglish{English}\cvrussian{английский}}{
            \cvenglish{Advanced}\cvrussian{Продвинутый}
        }
    ...
    \begin{cvsection}{\cvenglish{Work Experience}\cvrussian{Опыт работы}}
        \cventry{\cvenglish{since}\cvrussian{с} 10/2018}{
            \textbf{Joom},
            \cvenglish{Moscow, Russia}\cvrussian{Москва, Россия}
            ...
            \cvrussian{
                Разрабатываю движок рекомендаций для
            }%
