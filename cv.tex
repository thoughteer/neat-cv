...
\begin{document}
    ...
    \begin{cvsection}{\cvenglish{Education}\cvrussian{Образование}}
        \cventry{2013--2015}{
            \textbf{%
                \cvenglish{Ph.\,D.\ degree (unfinished)}\cvrussian{Аспирантура (неоконченная)}%
            },
    ...
    \begin{cvsection}{\cvenglish{Skills}\cvrussian{Навыки}}
        \cventry{\cvenglish{operating systems}\cvrussian{операционные системы}}{
            Mac OS X (\cvenglish{over}\cvrussian{свыше}
        ...
        \cventry{%
            ...
            Golang, Python, Java, C\,/\,C++, TypeScript, Zsh, Matlab, Factor, SQL
        }
        \cventry{\cvenglish{technologies}\cvrussian{технологии}}{
            AWS, Kubernetes, Spark, Hadoop\,/\,Hive, ZooKeeper, Kafka, MongoDB, Grafana, Prometheus, HashiCorp Vault, React, Effector, CUDA, OpenGL, DICOM, \LaTeX, HTML, CSS
        }
        \cventry{\cvenglish{tools}\cvrussian{инструменты}}{
            VS Code, IntelliJ IDEA, Vim, Git, Docker, GCC
        }
    \end{cvsection}
    \begin{cvsection}{\cvenglish{Spoken Languages}\cvrussian{Языки}}
        \cventry{\cvenglish{English}\cvrussian{английский}}{
            \cvenglish{Advanced}\cvrussian{Продвинутый}~(C1.5)
        }
    ...
    \begin{cvsection}{\cvenglish{Work Experience}\cvrussian{Опыт работы}}
        \cventry{\cvenglish{since}\cvrussian{с} 07/2021}{
            \textbf{Zerion},
            \cvenglish{remotely}\cvrussian{удаленно}

            \cvenglish{
                Developing DeFi portfolio tracking for
            }%
            \cvrussian{
                Разрабатываю трекер DeFi-портфолио для
            }%
            \cvurl{Zerion}{https://zerion.io/}, \cvenglish{including}\cvrussian{включающий}:

            \begin{cvlist}
                \cvitem{
                    \cvenglish{L1/L2 blockchain stream processing}
                    \cvrussian{потоковую обработку данных L1/L2 блокчейнов}
                }
                \cvitem{
                    \cvenglish{designing gRPC and REST APIs}
                    \cvrussian{дизайн gRPC и REST API}
                }
                \cvitem{
                    \cvenglish{dApp integration}
                    \cvrussian{интеграцию децентрализованных приложений}
                }
            \end{cvlist}
        }
        \cventry{10/2018--06/2021}{
            ...
            \cvenglish{
                Developing a recommendation engine for
            }%
            \cvrussian{
                Разрабатывал движок рекомендаций для
            }%
            \cvurl{Joom}{https://joom.com/}
        }
        \cventry{05/2015--09/2018}{
            ...
            \cvenglish{
                Developing a recommendation engine for
                \cvurl{Yandex.Market}{https://market.yandex.ru/}, including:
            }
            \cvrussian{
                Разрабатывал движок рекомендаций для
                \cvurl{Яндекс.Маркета}{https://market.yandex.ru/}, включающий:
            }
            \begin{cvlist}
                \cvitem{
                    \cvenglish{comprehensive offline data processing}
                    \cvrussian{комплексную оффлайновую обработку данных}
                }
                \cvitem{
                    \cvenglish{machine learning}
                    \cvrussian{машинное обучение}
                }
                \cvitem{
                    \cvenglish{high-load web services}
                    \cvrussian{высоконагруженные веб-сервисы}
                }
            \end{cvlist}
        }
